...
public class accountantBean {
	...
	public void setaccountantBean(accountantBean my_s) {
	this.name=my_s.getName();
	this.email=my_s.getEmail();
	this.address=my_s.getAddress();
	this.contact=my_s.getContact();
