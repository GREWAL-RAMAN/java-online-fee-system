...
<input type='hidden' name='function' id='function' value="insert" />
	...
	<input type='hidden' name='st_co_id' id='st_co_id'
		value='${st_co.getId()}' />
		<div class="form-group"> <label> Student Name:</label><input class="form-control" type="text"
		disabled="disabled" value="${st_co.getSt_name()}" id="st_name"></div>
<div class="form-group">
<label>	Course Name:</label><input class="form-control" type="text" disabled="disabled"
		value="${st_co.getCo_name()}" id="co_name"></div>
