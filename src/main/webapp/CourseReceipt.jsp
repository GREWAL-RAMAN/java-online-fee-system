...
<c:import url="navStudent.jsp" />
    <div id="content" class="container-fluid">  <center>  <h1>Receipt</h1></center>
	<table class="table">
		<tr>
			<td>Student Id:</td>
			<td><b><%=request.getParameter("st_id") %></b></td>
		</tr>
		<tr>
			<td>Student Name:</td>
...
<a href="studentHome.jsp"><button  class="btn btn-success btn-lg" >Home </button></a>
